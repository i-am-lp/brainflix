    ...
    const handleSubmit = async(event) => {
        ...
        try {
            const newVideo = {
              ...
              image: `${import.meta.env.VITE_APP_API_URL}/images/Upload-video-preview.jpg`, 
            };
            ...
            <div className='upload__desktop'>
                ...
                <div className="upload__form">
                    <form id="upload__form" className="upload__form" method="post" onSubmit={handleSubmit}>
                        ...
                        <textarea name="title" className="upload__form__empty upload__form--title" id="title" placeholder="Add a title to your video" onChange={(e) => setTitle(e.target.value)}></textarea>
                        <p className="upload__form--text">ADD A VIDEO DESCRIPTION</p>
                        <textarea name="description" className="upload__form__empty upload__form--description" id="description" placeholder="Add a description to your video" onChange={(e) => setDescription(e.target.value)}></textarea>
